...
##################################################################################################################################################################
##################################################################################################################################################################
RP.sim.m10 <- function(nx1=50,nmc=250,nrp=1000,r=5,minsplit=3,maxcompete=0,maxsurrogate=0,usesurrogate=0) {
...
y <- exp(5*(x1+x2))/(1 + (exp(5*(x1+x2)))) - 1 + eps
...
save(BigListResult,file = 'Sim_Results_m10.rda')
