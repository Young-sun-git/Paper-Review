...
##################################################################################################################################################################
##################################################################################################################################################################
RP.sim.m9 <- function(nx1=50,nmc=250,nrp=1000,r=5,minsplit=3,maxcompete=0,maxsurrogate=0,usesurrogate=0) {
...
save(BigListResult,file = 'Sim_Results_m9.rda')
